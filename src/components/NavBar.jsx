...
export default function NavBar() {
  ...
  return (
<div className="p-2 dark:bg-opacity-60 bg-opacity-60  fixed flex  justify-around text-center content-center bottom-0  w-full text-emerald-400  font-semibold bg-white dark:bg-zinc-900   backdrop-blur-md text-xs ">
